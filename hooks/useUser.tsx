 ...
 * to load user subscriptions
 * we can check whether the user has an active subscription or generally if we are authenticated or not
 */
...
export const useUser = () => {
    ...
    //trying to use this hook outside of our context 
